            ...
            <CardContent className="p-6">
                <div className="space-y-4">
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                        ...
                        <p className="text-base text-gray-600 dark:text-gray-400 pt-2">Jovian</p>
                        <p className="text-base">Issued - Dec 2021</p>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg mt-4">
                        ...
                        <p className="text-base text-gray-600 dark:text-gray-400 pt-2">Cybersecurity and Infrastructure Security Agency</p>
                        <p className="text-base">Issued - Sep 2021</p>
                        <ul className="list-disc list-inside mt-2 space-y-1">
                            <Button asChild>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg mt-4">
                        ...
                        <p className="text-base text-gray-600 dark:text-gray-400 pt-2">Code.org</p>
                        <p className="text-base">Issued - Jun 2019</p>
                        <ul className="list-disc list-inside mt-2 space-y-1">
                            <Button asChild>
