        ...
        <section id="home" className="mb-16">
          <div className="max-w-7xl mx-auto pt-16">
            <div className="flex flex-col-reverse md:flex-row items-center justify-center md:space-x-12 space-y-8 md:space-y-0">
              <div className="text-center md:text-left md:w-1/2 sm:pt">
                <h2 className="text-3xl font-normal mb-4">Hi, I'm</h2>
                <h2 className="text-5xl font-semibold mb-4">Mohd Ali Bin Naser</h2>
                <h2 className="text-3xl font-normal mb-4">Software Developer</h2>
                <p className="text-xl mb-8 font-light dark:font-thin">
